...
textFig = ['\bfNeuralDrift\rm',...
           ...
           sprintf('\n'), ...
           'the wheels of one side of a robot by using mental concetration.',...
           sprintf('\n'), ...
           'The goal is to guide the robot in the desired path by coordinating the ', ...
           sprintf('\n'), ...
           'concentraion levels of the players.',...           
           sprintf('\n\n'), ...
           '\bfInstructions\rm',...
           sprintf('\n'), ...
           ...
           sprintf('SPACE  \t Turns ON/OFF the EV3 robot\n'),...
           sprintf('      r        \t Restarts the Game from the Phase 1\n'),...
